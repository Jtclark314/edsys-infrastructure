...
collect_tar "pve-node3-config" "root" "192.168.50.54" "/etc/edsys-kali-stream" "/usr/local/libexec/edsys-kali-stream" "/etc/systemd/system/kali-stream-guard.service" "/etc/systemd/system/kali-stream-tcp@.service" "/etc/systemd/system/kali-stream-udp@.service" "/etc/pve" "/etc/network/interfaces" "/etc/network/interfaces.d" "/etc/edsys" "/etc/sysctl.d/99-edsys-security-lab.conf" "/etc/systemd/system/edsys-security-lab-guard.service" "/etc/systemd/system/edsys-security-lab-dhcp.service" "/usr/local/sbin/edsys-security-lab-guard" "/usr/local/sbin/verify-edsys-security-lab" "/etc/hosts" "/etc/hostname"
